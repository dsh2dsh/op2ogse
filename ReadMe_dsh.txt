...
- Оружие под патроны 12x70 разделено на 2 класса
  ...
  В одном классе длинноствольные охотничьи ружья. Имеют максимальную мощность
...
- Изменен третий апгрейд СКАТа-15.
  ...
  выключить/включить автоматическое лечение полностью или по
  отдельности: здоровье/кровотечение/пси-здоровье, радиация и
  выносливость. Как это выглядит можно посмотреть тут:
  https://youtu.be/oC2eJg1CLCM
...
- Еда и большинство частей мутантов постепенно портятся
  ...
  Полностью испорченную еду и части не принимают по циклическим заданиям,
  на обмен и их нельзя использовать для варки артефактов. Можно продать или
  выкинуть на землю - Зона приберет.
...
- Метки на карте
  ...
  Можно ставить метки со своим текстом. Для установки метки нужно сделать по
  карте двойной клик. Если кликнуть потом по этой метке правой кнопкой,
  можно будет удалить ее или поменять текст.
...
s.g.c._torch._v.1.0.xdb: "теплый ламповый" фонарик от adm-ral
...
Первый параметр задает дальность отрисовки травы. Дальше этого расстояния будет
голая земля. Этот параметр так же регулируется в настройках графики, в меню.
Второй параметр задает плотность травы, в зависимости от расстояния.
Изначально, трава рисуется по 4 куста в квадрате. С указанной выше настройкой,
через 50 метров трава будет рисоваться по 3 куста, через 100 - по два куста и
через 150 метров - по одному. Эти настройки можно написать в консоли игры или
сразу в user.ltx.
...
Я тут как-то в баре со знакомым долговцем встретился, постояли, попили
нормально. Так у него после второй бутылки язык развязался и он мне по секрету
выболтал, что среди долговцев недовольство растет. Говорит, раньше, когда на
Янтаре долговцы квадом работали, наряд туда чуть ли не отпуском считался.
А что? Зверье и зомбированных они не напрягаясь отстреливали, харчи у ученых
знатные, крыша над головой надежная, постели сухие, не то что на Свалке команда
Прапора у костерка под дождем ютится. А сейчас, когда Воронин на Янтарь решил
бойцов парами отправлять, таких среди своих начали "смертниками" называть.
Долговцы поговаривают, что таким образом Воронин от неугодных ему людей
избавляется, ибо наряд на Янтарь - верная смерть. Вот и начали в Долге у
костров перешептываться, мол, скрысился Воронин. Еще этот долговец сказал, что
даже сам полковник Петренко к Воронину ходил, просил, чтобы хотя бы тройками
бойцы на Янтаре работали, но видимо не удалось ему убедить генерала. Вобщем нет
согласия сейчас в Долге. Правда потом, когда протрезвел мой знакомый немного,
отпирался, говорил, мол, напридумывал, мол нет ничего такого о чем он говорил,
да и не помнит чего говорил-то. А я вот думаю, может и правда про Воронина-то?
Уж больно в глазах долговца страх виден был, когда понял он, чего наболтал
спьяну. Посмотрим, если через пару дней его на Янтаре увижу, значит так и есть
все.
