...
6. Если вы переходите со старого движка, то скопируйте свой user.ltx и
папку с сейвами в папку userdata.

Если вы до этого играли на старом движке и меняли fov консольной
командой cam_fov, то перед запуском, в своем user.ltx замените
"cam_fov" на "fov". Ну или после запуска укажите нужный fov в консоли.

Всё, можно запускать.

7. Сразу после запуска, перед началом новой игры или загрузки сейва,
