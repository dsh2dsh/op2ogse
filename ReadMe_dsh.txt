...
- Копируем всё из архива в папку с игрой и соглашаемся на замену.
  ...
  с заменой. Это нужно только тем, у кого звуковая карта умеет EAX и им не
  требуется его эмуляция с помощью EnvFx. Все остальные могут просто выключить
  EAX в настройках игры, без замены библиотек.
