...
- АМК опция "Живая" зона

  После включения этой опции мутанты не будут привязаны к своим местам
  и смогут перемещаться по локации, что позволит встречаться с ними в
  неожиданных местах.

  ВНИМАНИЕ! После влючения этой опции op2qucksave станет несовместимым
  с ОП-2. Назад пути не будет!
