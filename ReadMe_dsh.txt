...
- Массовый перенос предметов работает не совсем так, как в ОП-2:
  ...
  Если предмет перенести мышью или двойным кликом, а потом нажать клавишу
  "Z", то перенесенные предметы будут возвращены обратно.
