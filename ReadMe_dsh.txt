...
- Скопировать в эту папку всё из архива с последним обновлением, с
  ...
  Видео-инструкция по установке от Клика: https://youtu.be/iasiTdajNjE
...
Для установки любого дополнения, в папке с игрой нужно создать папку "mods"
и положить туда файл дополнения. При этом нужно убедиться, что в файле
fsgame.ltx, который тоже находится в папке с игрой, есть вот такая строка:
