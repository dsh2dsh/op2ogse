...
- https://yadi.sk/d/qqIRhL26oqUGn
- Зеркало: https://drive.google.com/open?id=0B0h2HnCBW9H1YzB6V21mc2FaMHc
...
- При разборке с Гавром не обязательно идти к ниму голым
  ...
  Все украденное будет потом возвращено Якутом, в полном объеме. В
  финальном диалоге с Гавром, у вас будет несколько секунд, что бы
  отступить за ближайшую колонну, прежде, чем начнется экшн.
