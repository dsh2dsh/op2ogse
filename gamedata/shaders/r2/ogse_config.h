...
/////////////////////////////////////////////////////////////
// Объемные саншафты
	#define SS_VOL_MAX_INTENSITY	float(0.10)	// максимальная интенсивность саншафтов
// Объемный свет
	#define VOL_LIGHT_MAX_INTENSITY	float(0.015)	// максимальная интенсивность объемного света от ламп
...
// Horizon-Based Ambient Occlusion	
	...
	#define HBAO_BLEND_FACTOR float(0.7)	// сила эффекта. 0 - отстутствует, 1 - полная сила.
...
//	#define DDOF_VIGNETTING					// эффект виньетирования (затемнение по краям изображения, н-р, для широкоугольных объективов)
		#define DDOF_VIGNOUT float(0.0)		// коэффициент яркости пикселей по краям экрана. 0 - полностью черные, 1 - незатененный цвет.
...
//	#define DDOF_CHROMATIC_ABERRATION
	...
	#define DDOF_GAIN float(3.0) 			// услиение яркости заблюренных областей. При увеличении, как правило, надо увеличивать DDOF_THRESHOLD.
...
// zoom depth of field
	...
	#define ZDOF_INTENSITY float(0.6)			// интенсивность эффекта. [0..1]
// reload depth of field
	...
	#define RDOF_SPEED float (5)			// скорость нарастания эффекта. Хорошие значения - 5-10
	#define RDOF_INTENSITY float (0.4)		// интенсивность эффекта. [0..1]
...
// Вода
	...
	#define PUDDLES_GROW_SPEED float(0.5)			// скорость роста луж
	#define USE_MOON_ROAD							// включить "лунную дорожку" на воде
...
// Флары от ламп
	...
	#define FL_USE_LONG_FLARE					// включить "длинный" флар
...
// Разное
	...
	#define USE_VOLUMETRIC_DUST								// включает "пыль" в объемном свете
