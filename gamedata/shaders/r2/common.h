...
half4 combine_bloom(half3 low, half4 high) { return half4(low + high * high.a, 1.h); }
...
half get_hemi(half4 lmh) { return dot(lmh.rgb, 1.h / 3.h); }

half get_sun(half4 lmh) { return lmh.a; }
