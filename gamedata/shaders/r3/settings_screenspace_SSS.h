...
#define G_SSDO_GRASS_HARDNESS 0.f //dsh: 1.0f // Grass shadow hardness.
...
#define G_SSDO_WEAPON_HARDNESS 0.f //dsh: 1.0f // Weapon shadow hardness. 0.0f to disable weapon shadows.
